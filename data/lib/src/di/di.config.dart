...
import 'package:data/src/di/di.dart' as _i37;
import 'package:data/src/repository/repository_impl.dart' as _i36;
import 'package:data/src/repository/source/api/app_api_service.dart' as _i34;
...
import 'package:data/src/repository/source/api/refresh_token_api_service.dart'
    as _i31;
import 'package:data/src/repository/source/database/app_database.dart' as _i27;
...
import 'package:data/src/repository/source/shared/mapper/language_code_data_mapper.dart'
    as _i14;
import 'package:domain/domain.dart' as _i35;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.factoryAsync<_i24.Store>(
      () => serviceModule.getStore(),
      preResolve: true,
    );
    gh.factory<_i25.TwitterErrorResponseMapper>(
        () => _i25.TwitterErrorResponseMapper());
    gh.factory<_i26.ApiUserDataMapper>(() => _i26.ApiUserDataMapper(
          gh<_i18.GenderDataMapper>(),
          gh<_i18.ApiImageUrlDataMapper>(),
        ));
    gh.lazySingleton<_i27.AppDatabase>(
        () => _i27.AppDatabase(gh<_i24.Store>()));
    gh.lazySingleton<_i28.AppPreferences>(
        () => _i28.AppPreferences(gh<_i23.SharedPreferences>()));
    gh.factory<_i29.AccessTokenInterceptor>(
        () => _i29.AccessTokenInterceptor(gh<_i18.AppPreferences>()));
    gh.lazySingleton<_i30.RefreshTokenApiClient>(
        () => _i30.RefreshTokenApiClient(
              gh<_i18.HeaderInterceptor>(),
              gh<_i18.AccessTokenInterceptor>(),
            ));
    gh.lazySingleton<_i31.RefreshTokenApiService>(
        () => _i31.RefreshTokenApiService(gh<_i18.RefreshTokenApiClient>()));
    gh.factory<_i32.RefreshTokenInterceptor>(() => _i32.RefreshTokenInterceptor(
          gh<_i18.AppPreferences>(),
          gh<_i18.RefreshTokenApiService>(),
          gh<_i18.NoneAuthAppServerApiClient>(),
        ));
    gh.lazySingleton<_i33.AuthAppServerApiClient>(
        () => _i33.AuthAppServerApiClient(
              gh<_i18.HeaderInterceptor>(),
              gh<_i18.AccessTokenInterceptor>(),
              gh<_i18.RefreshTokenInterceptor>(),
            ));
    gh.lazySingleton<_i34.AppApiService>(() => _i34.AppApiService(
          gh<_i18.NoneAuthAppServerApiClient>(),
          gh<_i18.AuthAppServerApiClient>(),
          gh<_i18.RandomUserApiClient>(),
        ));
    gh.lazySingleton<_i35.Repository>(() => _i36.RepositoryImpl(
